      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <motion.p
              variants={item}
              className="text-xl md:text-2xl text-gray-500 font-light mb-12 max-w-2xl mx-auto leading-relaxed"
            >
            ...
            >
              ...
              <Link
                href="/login"
                className="text-gray-500 hover:text-gray-900 font-medium px-6 hover:underline"
              >
            ...
            <motion.div
              variants={item}
              className="grid grid-cols-3 gap-8 border-t border-gray-100 pt-12 max-w-3xl mx-auto"
            >
              <div>
                <motion.div
                  initial={{ opacity: 0 }}
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row-reverse items-center gap-16">
            ...
            >
              ...
              <p className="text-sm font-bold text-purple-600 uppercase tracking-widest mb-6">
                {t("Landing.feature_2_highlight")}
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
              ...
              >
                ...
                >
                  <p className="text-white text-sm font-medium">
                    &ldquo;I can definitely handle that objection by...&rdquo;
                  </p>
                </motion.div>
                <motion.div
                  initial={{ scale: 0 }}
                  ...
                  className="bg-yellow-900/10 rounded-2xl p-4 self-start max-w-[80%] border-l-4 border-yellow-500"
                >
                  <p className="text-yellow-400 text-xs font-bold mb-1">
                    CURVEBALL DETECTED
                  </p>
                  <p className="text-gray-300 text-sm">
                    &ldquo;But what if the budget gets cut in half
                    tomorrow?&rdquo;
                  </p>
                </motion.div>
              </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            >
              ...
              <p className="text-sm font-bold text-pink-600 uppercase tracking-widest mb-6">
                {t("Landing.feature_3_highlight")}
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4">
                  {t(`Landing.impact_${i}_title`)}
                </h3>
                {/* @ts-ignore */}
                <p className="text-gray-400 leading-relaxed">
                  {t(`Landing.impact_${i}_text`)}
                </p>
              </motion.div>
            ))}
          </div>
